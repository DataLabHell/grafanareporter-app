...
![An example report generated by Grafana Reporter — a dashboard rendered to a branded PDF](src/img/example-report.png)
...
Defaults — layout, branding and the logo library — are configured on the plugin's configuration page:

![Grafana Reporter configuration page, including the logo library](src/img/configuration.png)
